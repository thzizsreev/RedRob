...
Outputs under experiments/kmeans/precomputed/<pool>/:
...
from experiments.kmeans.io import load_inputs
from experiments.kmeans.precompute_artifacts import (
    PrecomputeManifest,
    assert_precompute_artifacts_absent,
    save_precompute_artifacts,
)
from experiments.kmeans.test.reduce import reduce_embeddings
from experiments.kmeans.test.sampling import Sample, subsample_inputs
