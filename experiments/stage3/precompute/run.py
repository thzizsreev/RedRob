...
from experiments.stage3.precompute.cohort import (
    build_cohort,
    build_survivor_indices,
    write_stage0_pointer,
)
from experiments.stage3.precompute.manifest import cohort_config_hash, query_config_hash
from experiments.stage3.precompute.query_vectors import build_query_vectors
from experiments.stage3.shared.config_precompute import DEFAULT_CONFIG, load_precompute_config
from experiments.stage3.shared.io_precompute import (
    PrecomputeManifest,
    load_manifest,
    utc_now_iso,
    write_manifest,
...
def main() -> None:
    ...
    print("\nPrecompute complete. Run: python experiments/stage3/runner/run.py")
