"""CPU ONNX embedder for experiments.stage3 (no CUDA requirement)."""
...
class InstructorONNX:
    """Same encode API as production embedder; CPU-only for test runs."""
...
def load_embedder() -> InstructorONNX:
    print("Loading INSTRUCTOR-large ONNX embedder (CPU, experiments.stage3)...")
