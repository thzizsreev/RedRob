...
from clustering.cluster import compute_metrics, run_hdbscan
from clustering.inspect import build_cluster_inspection
from clustering.io import load_vectors_and_records
from clustering.outliers import build_noise_export
from clustering.persist import persist_artifacts
from clustering.reduce import reduce_embeddings
from clustering.sampling import stratified_sample
from clustering.visualize import write_cluster_plot, write_landmark_plot
...
def run_clustering_pipeline(
    ...
    *,
    ...
    inputs = load_vectors_and_records(candidates_path, artifacts_path)
