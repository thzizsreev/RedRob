...
cands = json.loads(Path("test_q1_q2_revised/input/test_candidates.json").read_text(encoding="utf-8"))
rows = []
...
from test_stage_3.shared.cpu_embedder import load_embedder
