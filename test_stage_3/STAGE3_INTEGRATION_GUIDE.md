...
`test_stage_3/` into production `tracks/instructor/stage3/`.
...
```bash
python test_stage_3/precompute/run.py          # or --force to rebuild
python test_stage_3/runner/run.py
python test_stage_3/runner/validate_output.py
```
...
```json
{
  ...
  "paths": {
    "query_vectors_dir": "test_stage_3/precompute/artifacts/query_vectors",
    "cohort_stage2": "test_stage_3/precompute/artifacts/cohort/stage2_gated.parquet",
    "cohort_features": "test_stage_3/precompute/artifacts/cohort/candidate_features.parquet",
    "survivor_row_indices": "test_stage_3/precompute/artifacts/cohort/survivor_row_indices.npy",
    "stage0_pointer": "test_stage_3/precompute/artifacts/stage0_pointer.json"
  }
}
```
...
| Date | Change |
|------|--------|
| 2026-06-26 | Initial `test_stage_3/` monolithic skill-track implementation |
