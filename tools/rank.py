...
from tracks.shared.paths import ROOT_DIR, RUNTIME_STAGE0_DIR, RUNTIME_STAGE1_DIR, TEST_RUNS_DIR
...
RESULTS_PATH = TEST_RUNS_DIR / "retrieval" / "retrieval_results_sample1k.json"
