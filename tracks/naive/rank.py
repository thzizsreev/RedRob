...
from tracks.naive.config import ARTIFACTS_DIR, JD_QUERY_TEXT, RANK_RESULTS_FILENAME
from tracks.naive.encode import encode_query, load_encoder
from tracks.naive.store import load_index


def run_rank(*, k: int = 50) -> list[dict]:
    print("=" * 60)
    print("NAIVE RANK — JD query retrieval")
    print("=" * 60)
